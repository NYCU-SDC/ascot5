...
#pragma omp declare simd uniform(asigmadata, znum, anum, nspec, extrapolate) simdlen(NSIMD)
#pragma omp declare simd inbranch uniform(asigmadata, znum, anum, nspec, extrapolate) simdlen(NSIMD)
...
#pragma omp declare simd uniform(asigma_data, znum, anum, nion, extrapolate) simdlen(NSIMD)
#pragma omp declare simd inbranch uniform(asigma_data, znum, anum, nion, extrapolate) simdlen(NSIMD)
