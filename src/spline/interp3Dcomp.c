...
/* interp3Dcomp_eval_f_precomputed, interp3Dcomp_eval_f, and
   interp3Dcomp_eval_f3 are static inline in interp.h */
 ...
 *
 * This function is a lighter variant of interp3Dcomp_eval_df and returns only
 * f and first derivatives.
 *
